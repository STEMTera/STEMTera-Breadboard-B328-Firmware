...
/** \file
 *
 *  Header file for STEMTera-Breadboard-usbdfu.c
 */

#ifndef _STEMTERA_USB_DFU_BOOTLOADER_H_
#define _STEMTERA_USB_DFU_BOOTLOADER_H_
...
#endif /* _STEMTERA_USB_DFU_BOOTLOADER_H_ */
